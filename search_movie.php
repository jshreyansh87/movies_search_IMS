...
<body>
  ...
  <?php
    $movie_name_searched = mysqli_real_escape_string($db,$_POST['movie_name_searched']);
    $sql = "SELECT * FROM movies WHERE movie_name = '$movie_name_searched'";
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4" style="padding-left: 25px;">
    ...
    <form method="post" action="movie.php">
      <div class="col">
        <div class="card h-100" style="width: 18rem; height: 620px;">
